...
/*
* This activity loads a map and change the background color
* */
public class ExampleChangeBackgroundColor extends Activity {
            ...
            @Override public void onLoadCompleted(Airport _airport, Map _map, final MapView _mapView,
                ...
                _mapView.setOnReadyListener(new MapView.OnReadyListener() {
                    ...
                    public void onReady() {
                        ...
                        myTheme.setProperty("view.search.color.background", Color.MAGENTA);
