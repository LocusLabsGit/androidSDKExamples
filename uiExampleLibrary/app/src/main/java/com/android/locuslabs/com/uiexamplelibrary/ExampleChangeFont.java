...
/*
* This activity loads a map and change the font of the search bar text
* */
public class ExampleChangeFont extends Activity {
            ...
            @Override public void onLoadCompleted(Airport _airport, Map _map, final MapView _mapView,
                ...
                _mapView.setOnReadyListener(new MapView.OnReadyListener() {
                    ...
                    public void onReady() {
                        ...
                        myTheme.setProperty("view.overlay.searchbar.placeholder.font.name",Typeface.create(Typeface.MONOSPACE,Typeface.NORMAL));
